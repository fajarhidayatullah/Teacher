  ...
  Image = (function(_super) {
    ...
    Image.prototype.doRender = function(e) {
      ...
      if (this.source) {
        ...
        paper = Raphael(this.e.get()[0], this.width - 2 * this.borderThickness, this.height - 2 * this.borderThickness);
        path = paper.path("M 0 0 L " + this.width + " " + this.height);
        path.attr('stroke', this.borderColor).attr('stroke-width', this.borderThickness);
        path = paper.path("M " + (this.width - 1 * this.borderThickness) + " 0 L 0 " + (this.height - 1 * this.borderThickness));
        path.attr('stroke', this.borderColor).attr('stroke-width', this.borderThickness);
      }
